...
public class Main {
    public static void main(String[] args) {
        ...
        if (age >= 18) {
            ...
            int tOfAir = 10;
            if (tOfAir < 5) {
                System.out.println("На улице " + tOfAir + " градусов, нужно надеть шапку");
            } else {
                System.out.println("Сегодня " + tOfAir + " градусов, можно идти без шапки");
            }
            //Задача 3
            int speed = 50;
            if (speed > 60) {
                System.out.println("Если скорость " + speed + " км/ч, то скорость превышена и придется заплатить штраф");
            } else {
